...
import br.com.loysciapp.loysci_android.databinding.ActivityMisionBinding;
...
import br.com.loysciapp.loysci_android.presentation.ui.adapters.MissionActivitiesAdapter;
import br.com.loysciapp.loysci_android.presentation.ui.listeners.SimpleItemClickListener;
import br.com.loysciapp.loysci_android.util.Utilities;
...
import static br.com.loysciapp.loysci_android.util.Constants.REWARD_TOTAL;
...
public class MissionActivity extends AppCompatActivity implements SimpleItemClickListener {
    ...
    private void updateCompletedCounter() {
        ...
        binding.txtActivitiesCount.setText(completedCounter + "/" + mission.getChallenges().size());
    }
