...
import br.com.loysciapp.loysci_android.databinding.ActivityQuizBinding;
import br.com.loysciapp.loysci_android.model.Challenge;
import br.com.loysciapp.loysci_android.presentation.ui.adapters.QuizOptionsAdapter;
import br.com.loysciapp.loysci_android.presentation.ui.listeners.SimpleItemClickListener;
import br.com.loysciapp.loysci_android.presentation.ui.listeners.ViewModelSimpleCallback;
import br.com.loysciapp.loysci_android.presentation.ui.viewModels.QuizViewModel;
import br.com.loysciapp.loysci_android.util.ActivityExitDialog;
import br.com.loysciapp.loysci_android.util.MissionEndDialog;
import br.com.loysciapp.loysci_android.util.QuizEndDialog;

import static br.com.loysciapp.loysci_android.util.Constants.CHALLENGE_PARCELABLE;
import static br.com.loysciapp.loysci_android.util.Constants.EXIT_BUTTON_TRIGGERED;
import static br.com.loysciapp.loysci_android.util.Constants.EXIT_TOOLBAR_TRIGGERED;
import static br.com.loysciapp.loysci_android.util.Constants.ID_MEMBER;
import static br.com.loysciapp.loysci_android.util.Constants.ID_MISSION;
import static br.com.loysciapp.loysci_android.util.Constants.ID_TOPIC;
import static br.com.loysciapp.loysci_android.util.Constants.MISSION_FINISHED;
import static br.com.loysciapp.loysci_android.util.Constants.QUIZ_COMPLETED_RIGHT;
import static br.com.loysciapp.loysci_android.util.Constants.QUIZ_COMPLETED_WRONG;
import static br.com.loysciapp.loysci_android.util.Constants.REMAINING_ACTIVITIES;
...
public class QuizActivity extends AppCompatActivity implements SimpleItemClickListener {
    ...
    private void checkQuestion() {
        if (adapter.getSelected() == -1) {
            ...
            setCorrectChallenge(adapter.getSelected());
...
//        });
    ...
    private void setCorrectChallenge(int selected) {


        model.setChallengeCorrect(model.challenge, model.challenge.getMisionEncuestaPreguntas().get(0), selected + 1, new ViewModelSimpleCallback() {
            @Override
            public void onSuccess() {

                if (remainingQuestions <= 1) {
                    MissionEndDialog dialog = new MissionEndDialog(QuizActivity.this, getString(R.string.points, rewardTotal), model.challenge, model.challenge.getValor(), 0, remainingQuestions - 1, true, adapter.getAnswer(currentRightAnswer));
                    dialog.show();
            ...
            public void onFailed(Object object) {
                ...
                if (object.equals(QUIZ_COMPLETED_WRONG)) {
