...
import br.com.loysciapp.loysci_android.databinding.ActivityMainBinding;
import br.com.loysciapp.loysci_android.model.Level;
...
import br.com.loysciapp.loysci_android.mvp.share.ShareWithFriendsActivity;
import br.com.loysciapp.loysci_android.presentation.ui.fragments.HomeFragment;
import br.com.loysciapp.loysci_android.presentation.ui.listeners.ViewModelSimpleCallback;
import br.com.loysciapp.loysci_android.presentation.ui.presenters.MainActivityPresenter;
...
import br.com.loysciapp.loysci_android.util.WelcomeMessageDialog;

import static br.com.loysciapp.loysci_android.util.Constants.*;
...
public class MainActivity extends AppCompatActivity implements HomeFragment.HomeOptionsListener, View.OnClickListener {
    ...
    private void setNameLastname() {
        ...
        if (jsonProfile != null) {
            ...
            nomeSobrenome = savedProfile.getNombre() + " " + savedProfile.getApellido();
            binding.nomeSobrenome.setText(nomeSobrenome);
        }
    }
