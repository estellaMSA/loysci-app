...
import br.com.loysciapp.loysci_android.databinding.ActivityProfileBinding;
...
import br.com.loysciapp.loysci_android.presentation.presenter.EditAddressPresenter;
import br.com.loysciapp.loysci_android.presentation.presenter.ProfileActivityPresenter;
import br.com.loysciapp.loysci_android.util.AddressUtil;
import br.com.loysciapp.loysci_android.util.Constants;
import br.com.loysciapp.loysci_android.util.CustomPhotoPickerDialog;
import br.com.loysciapp.loysci_android.util.MaskWatcher;
import br.com.loysciapp.loysci_android.util.PhoneNumberFormatter;
...
public class ProfileActivity extends AppCompatActivity {
    ...
    private static final int CAMERA_REQUEST = 9068;
    ...
    public void getProfileFromView(Profile profile, String profileBase64) {
            ...
            EasyImage.handleActivityResult(requestCode, resultCode, data, this, new DefaultCallback() {
                ...
                public void onImagesPicked(List<File> imagesFiles, EasyImage.ImageSource source, int type) {
                    ...
                    if (requestCode == PICK_PICTURE_FROM_GALLERY) {
                        ...
                        if (bitmap != null) {
                            bitmap = presenter.setGalleryRequest(data);
