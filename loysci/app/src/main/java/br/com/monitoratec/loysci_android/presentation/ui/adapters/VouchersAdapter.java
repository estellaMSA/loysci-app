...
import br.com.monitoratec.loysci_android.databinding.ItemVoucherCardBinding;
import br.com.monitoratec.loysci_android.model.Reward;
import br.com.monitoratec.loysci_android.presentation.ui.activities.VoucherActivity;
...
public class VouchersAdapter extends RecyclerView.Adapter<VouchersAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        if (reward.getEncabezadoArte().toLowerCase().contains("zattini")) {
            ...
            holder.binding.ivImageLogo.setVisibility(View.GONE);
